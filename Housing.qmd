...
```{r}
#| tbl-cap: !expr sprintf("%s Housing Security Screening.", NextTable())
...
**Summary: ** A total of `r get_count_and_percent(bns$q34, "Never")` students reported never being unsure of where they are going to sleep in the past 12 months, while `r get_count_and_percent(bns$q34, "Never")` were unsure on one occasion, `r get_count_and_percent(bns$q34, "Never")` were unsure on two occasions, and `r get_count_and_percent(bns$q34, "Never")`, were unsure on three or more occasions. 
