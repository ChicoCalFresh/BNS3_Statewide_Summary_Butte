...
plot_frq(bns$q16, geom.colors = plot_color, ylim=c(0, ylim=c(0, 1.3*max(table(bns$q16)))), wrap.labels = 16, sort.frq = 'desc') + xlab('') + ylab("Number of Students") + theme(axis.text.x = element_text(size = 10))
...
**Summary:** A total of `r count_and_percent(bns$q14_3, "Yes")` students identified as a student with a disability, `r count_and_percent(bns$q14_1, "Yes")` identified as transfer students, `r count_and_percent(bns$q14_8, "Yes")` identified as students with English as their second language, and `r count_and_percent(bns$q14_2, "Yes")` identified as LGBTQA+.
